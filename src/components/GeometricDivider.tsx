        ...
        <g filter="url(#infinityGlow)">
          ...
          <path
            d="M20,16 
               ...
               C28,64 28,52 24,48 
               C20,44 20,36 24,32 
               C28,28 28,16 20,16 Z"
            stroke="url(#infinityGradient)"
            strokeWidth="0.6"
            fill="none"
          />
          
          {/* Inner vertical infinity - offset for depth */}
          <path
            d="M20,20 
               C14,20 14,28 17,31 
               C20,34 20,46 17,49 
          ...
          {/* Horizontal accent lines through center */}
          <line x1="14" y1="40" x2="26" y2="40" stroke="#FAFAF8" strokeWidth="0.2" opacity="0.3" />
          
          {/* Center crossing point - sacred geometry touch */}
          ...
          {/* Vertical axis line - very subtle */}
